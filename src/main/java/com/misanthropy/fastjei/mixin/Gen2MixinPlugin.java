...
public final class Gen2MixinPlugin extends GenerationMixinPlugin {

	private static final String PACKAGE = "com.misanthropy.fastjei.gen2.mixin.";

	@Override
	protected JeiGeneration generation() {
		return JeiGeneration.GEN2;
	}
